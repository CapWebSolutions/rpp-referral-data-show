...
if (!class_exists('ReferralPluginMain')) {
    class ReferralPluginMain
    {
        ...
        {
            $exampleListTable = new ShowReferralData();
      ...
      /*   public function list_table_page()
        {
          ...
          <h2>All Referrals</h2>';
            ...
            $exampleListTable->search_box('Search', 'referral_search');
            echo '</form>';
        ...
        public function handle_csv_download()
        {
            if (isset($_POST['action']) && $_POST['action'] === 'download_csv') {
                $exampleListTable = new ShowReferralData();
                $exampleListTable->prepare_items(); // Make sure data is prepared

                // Generate CSV data
                $csv_data = $exampleListTable->generate_csv();
